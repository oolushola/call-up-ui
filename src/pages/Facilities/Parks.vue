						...
						<div class="card">
							<div class="card-body">
								...
								<p class="card-title-desc">
									Hi {{ capitalizer($store.state.user.name) }}, you have
									{{ userParks.length }} associated with your account.
								</p>
								...
								<div v-else class="table-responsive">
									<table class="table table-striped mb-0">
										...
										<tbody>
											<record-not-found
												v-if="userParks.length === 0"
												colspan="10"
												label="You have no park associated with your account."
											/>
											<user-park-item
												v-else
												v-for="(park, index) in userParks"
												:key="park._id"
												:park="park"
												:counter="index"
											></user-park-item>
