				...
				<div class="h-50">
					...
					<div id="sidebar-menu" style="">
						...
						<ul class="metismenu list-unstyled" id="side-menu">
							...
							<li v-if="userType === 'union'">
								<router-link :to="{ name: 'CreateUnion' }">
									<i class="bx bxs-report"></i>
									<span>Create Union</span>
								</router-link>
							</li>
							<li v-if="userType != 'policing'">
								<router-link
									:to="{
										name: 'profile',
										params: { name: slugify($store.state.user.name) },
									}"
								>
							...
							<li v-if="userType === 'terminal' || userType === 'admin'">
								<a href="javascript:void(0)">
									...
									<span key="t-invoices"
										>Terminal<i
											class="bx bx-chevron-right d-xl-inline-block"
										></i
									></span>
								</a>
								<ul class="sub-menu" aria-expanded="false">
									...
									<li>
										<router-link :to="{ name: 'calledInTrucks' }">
											Access Control
										</router-link>
									</li>
									<li>
										<router-link :to="{ name: 'terminalHistory' }">
											History
										</router-link>
									</li>
									<li>
										<router-link :to="{ name: 'matchedTdo' }">
											Matched TDO/TRO
										</router-link>
									</li>
									<li>
							...
							<div v-if="userType === 'admin' || userType === 'agent'">
								<li>
									<router-link :to="{ name: 'assignedTdo' }">
										...
										<span>View TDO/TRO</span>
									</router-link>
								</li>
								<li>
									<router-link :to="{ name: 'calledOutTrucks' }">
										<i class="bx bx-phone-call"></i>
										<span>Called Up Trucks</span>
									</router-link>
								</li>
								<li>
									<a href="javascript:void(0)">
										<i class="bx bxs-phone-call"></i>
										<span>Manage Call Up</span>
									</a>
								</li>
							</div>
							<li v-if="userType === 'transporter' || userType === 'admin'">
								<a href="javascript:void(0)">
									...
									<span key="t-invoices"
										>Truck Management
										<i class="bx bx-chevron-right d-xl-inline-block"></i
									></span>
								</a>
								<ul class="sub-menu" aria-expanded="false">
									<li>
										<router-link
											:to="{ name: 'TruckManagement' }"
											key="t-invoice-list"
										>
											Add New Truck
										</router-link>
									...
									<li>
										<router-link :to="{ name: 'verifiedTrucks' }">
											Truck Fleets
											<span class="badge rounded-pill bg-info float-end">{{
												$store.getters.getVerifiedTrucks.length
											}}</span>
										</router-link>
									</li>
								</ul>
							...
							<li v-if="userType !== 'terminal' && userType !== 'union'">
								<router-link :to="{ name: 'trucksInPark' }">
									<i class="bx bxs-truck"></i>
									Trucks In Park
							...
							<li v-if="userType === 'transporter' || userType === 'admin'">
								<router-link :to="{ name: 'HoldingBays' }" class="waves-effect">
									<i class="bx bxs-truck"></i>
									<span key="t-authentication">Book Park</span>
								</router-link>
							</li>
							<li v-if="userType === 'park owner' || userType === 'admin'">
								...
								<ul class="sub-menu" aria-expanded="false">
									<li>
										<router-link :to="{ name: 'newPark' }" key="t-invoice-list">
											Add Park
										</router-link>
									</li>
									<li>
										<router-link :to="{ name: 'parks' }">
											Manage Park Activities
										</router-link>
									</li>
									<li>
										<router-link :to="{ name: 'parkActivity' }">
											Access Control
										</router-link>
									</li>
									<li>
							...
							<div class="" v-if="userType === 'admin'">
								<li>
									...
									<ul class="sub-menu" aria-expanded="false">
										...
										<li>
											<a href="#" key="t-timeline">Update Truck Status</a>
										</li>
