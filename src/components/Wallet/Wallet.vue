								...
								<div class="d-flex">
									...
									<div class="flex-grow-1">
										<div class="text-muted">
											...
											<p v-if="!getWalletDetails">
												<i class="bx bx-loader bx-spin"></i>
											</p>
											<p v-else class="mb-0">
												Wallet Id: {{ getWalletDetails._id }}
											</p>
										</div>
									</div>
								</div>
										...
										<div class="d-flex">
											...
											<div class="flex-grow-1">
												...
												<h5 v-else class="mb-1">
													&#x20A6;{{
														currencyFormatter(getWalletDetails.availableBalance)
													}}
												</h5>
									...
									<div class="card-body">
										<div class="d-flex">
											...
											<div class="flex-grow-1">
												...
												<p class="text-muted mb-2" v-else>Received</p>
												<p v-if="!getWalletDetails">
													<i class="bx bx-loader bx-spin"></i>
												</p>
												<h5 v-else class="mb-0">
													&#x20A6;{{
														currencyFormatter(getWalletDetails.lastDeposit)
													}}
												</h5>
										...
										<div class="d-flex">
											...
											<div class="flex-grow-1">
												...
												<h5 v-else class="mb-0">
													&#x20A6;
													{{
														currencyFormatter(getWalletDetails.lastAmountSpent)
													}}
												</h5>
